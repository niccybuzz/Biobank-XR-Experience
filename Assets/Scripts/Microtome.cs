...
public class Microtome : SnappablePlatform
{
    ...
    private GameObject _mostRecentBlockAttached;

    public GameObject MostRecentBlockAttached { get => _mostRecentBlockAttached; set => _mostRecentBlockAttached = value; }

    // Called every time a block is attached to the platform. Updates the most recent block attached
    public void AttachBlock()
    {
        _mostRecentBlockAttached = GetObjectOnPlatform();
    ...
    {
        _mostRecentBlockAttached.SetActive(false);
    }
